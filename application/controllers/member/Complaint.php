							  ...
							  if(strlen($_FILES['file_picture']['name'])>0 && $_FILES['file_picture']['size']>0)
								{
									...
									{
										$file_pictures = "uploads/images/complaint/".$_FILES['file_picture']['name'];
										$file_picture = preg_replace('/\s+/', '_', $file_pictures);
...
$this->db->or_like('updated_at', $key, 'both');
	...
	function export($export_type='CSV'){
	  if($export_type=='CSV'){	
		   ...
		   // get data 
		   $this->db->order_by('id', 'desc');
		   $complaintData = $this->Complaint_model->get_users_complaint();
		   // file creation 
